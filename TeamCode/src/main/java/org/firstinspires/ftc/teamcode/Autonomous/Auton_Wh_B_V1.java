...
//@Disabled
@Autonomous(name = "Auton_Wh_B_V1")
public class Auton_Wh_B_V1 extends LinearOpMode implements Auton_Values{
...
//Read Barcode
            ...
            if(elementPosition != 3) { //if 1st or 2nd
                Drive(distance_between_squares, "Left");
                checkPos(2); //go to 2nd sq and check
                if(elementPosition == 0) {
                    elementPosition = 1;
                }
                Drive(distance_between_squares, "Right"); //go back to 3rd
            }
...
//Drop Block in Tower
            ...
            Drive(8, "Right"); //idk how much 8 should be
